...
?>
 <div id="content-header">
    <div id="breadcrumb"> <a href="index.php?page=dashboard" title="kembali ke beranda" class="tip-bottom"><i class="icon-home"></i> Home</a><a href="index.php?page=hasil_survey" title="pergi ke data survey" class="tip-bottom">hasil Survey</a><a href="#" title="pergi ke data survey" class="tip-bottom">seleksi</a>
   </div>
     ...
     <div class="widget-box">
      <div class="widget-title"><span class="icon"> <i class="icon-pencil"></i> </span>
       ...
       <div class="pull-right">
                  ...
                  <tr>
                  <td>
                  <a class="btn btn-success btn-large pull-right" href="index.php?page=seleksi_proses&no_survey=<?php echo $no_survey?>&status=1" title="konfirmsai data ini" onclick="return confirm('ANDA YAKIN PESERTA INI LULUS... ?')">LULUS</a>
                   </td>
                    <td>
                  <a class="btn btn-danger btn-large pull-right" href="index.php?page=seleksi_proses&no_survey=<?php echo $no_survey?>&status=2" title="konfirmsai data ini" onclick="return confirm('ANDA YAKIN PESERTA INI TIDAK LULUS ... ?')">Tidak LULUS</a>
                  </td>
                   </tr>
                   </table> 
                   </div>
